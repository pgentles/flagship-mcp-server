...
server.tool(
  ...
  {
    document: import_zod2.z.string().describe("Consumer complaint or collection letter text"),
    type: import_zod2.z.string().describe("Document type: 'complaint', 'letter', 'notice', 'call_log'")
  },
  async (args) => {
...
server.tool(
  ...
  {
    document: import_zod2.z.string().describe("Full text of the complaint or legal document"),
    type: import_zod2.z.string().describe("Document type: 'complaint', 'letter', 'notice'")
  },
  async (args) => {
