...
var PAYMENT_HEADER = "X402-Payment";
var FALLBACK_PAYMENT = "simulated-mcp-payment";
async function callService(serviceUrl, endpoint, method, body, query) {
...
async function runHealthProbe() {
  const promises = Object.entries(SERVICES).map(async ([key, svc]) => {
    try {
      const res = await import_axios.default.get(`${svc.baseUrl}/health`, { timeout: 5e3 });
...
server.tool(
  ...
  { symbol: import_zod2.z.string().describe("Crypto symbol (e.g. BTC, ETH, SOL)") },
  async (args) => {
...
server.tool(
  ...
  { symbol: import_zod2.z.string().describe("Crypto symbol (e.g. BTC, ETH)") },
  async (args) => {
...
server.tool(
  ...
  {
    symbol: import_zod2.z.string().describe("Crypto symbol"),
    hours: import_zod2.z.number().optional().describe("Forecast horizon in hours (default: 24)")
  },
  async (args) => {
...
server.tool(
  ...
  {
    symbol: import_zod2.z.string().describe("Crypto symbol"),
    direction: import_zod2.z.string().describe("Intended direction: long or short"),
    amount_usd: import_zod2.z.number().optional().describe("Position size in USD")
  },
  async (args) => {
...
server.tool(
  ...
  {
    complaint: import_zod2.z.string().describe("Consumer complaint or collection letter text (min 10 characters)")
  },
  async (args) => {
...
server.tool(
  ...
  {
    complaint: import_zod2.z.string().describe("Full text of the complaint or legal document (min 10 characters)")
  },
  async (args) => {
...
server.tool(
  ...
  {
    document: import_zod2.z.string().describe("Document text or policy to analyze"),
    type: import_zod2.z.string().describe("Document type: 'policy', 'contract', 'notice', 'procedure'")
  },
  async (args) => {
...
server.tool(
  ...
  {
    document: import_zod2.z.string().describe("Full document or policy text"),
    type: import_zod2.z.string().describe("Document type: 'policy', 'contract', 'notice'"),
    sections: import_zod2.z.string().optional().describe("Comma-separated list of specific sections to check")
  },
  async (args) => {
...
server.tool(
  ...
  { resume: import_zod2.z.string().describe("Resume text") },
  async (args) => {
...
server.tool(
  ...
  {
    resume: import_zod2.z.string().describe("Current resume text"),
    job_description: import_zod2.z.string().describe("Target job posting or description")
  },
  async (args) => {
...
server.tool(
  ...
  {
    resume: import_zod2.z.string().describe("Resume text"),
    job_description: import_zod2.z.string().describe("Job posting text")
  },
  async (args) => {
...
server.tool(
  ...
  {
    url: import_zod2.z.string().describe("URL to monitor (https recommended)"),
    agent: import_zod2.z.string().describe("Your agent identifier"),
    keyword: import_zod2.z.string().optional().describe("Optional keyword that must appear on the page")
  },
  async (args) => {
...
server.tool(
  ...
  {
    url: import_zod2.z.string().describe("URL to remove"),
    agent: import_zod2.z.string().describe("Agent identifier")
  },
  async (args) => {
...
server.tool(
  ...
  {
    url: import_zod2.z.string().describe("Monitored URL"),
    agent: import_zod2.z.string().describe("Agent identifier")
  },
  async (args) => {
    const res = await callService(SERVICES.infra.baseUrl, `/api/status/${encodeURIComponent(args.url)}`, "GET", void 0, { agent: args.agent });
    return { content: [{ type: "text", text: JSON.stringify(res.data) }] };
  }
);
server.tool(
  ...
  {
    url: import_zod2.z.string().describe("URL to check"),
    keyword: import_zod2.z.string().optional().describe("Optional keyword to verify presence on page"),
    timeout: import_zod2.z.number().optional().describe("Timeout in milliseconds (default: 10000)")
  },
  async (args) => {
...
server.tool(
  ...
  async () => {
    ...
    for (const [key, svc] of Object.entries(SERVICES)) {
      try {
        const res = await import_axios.default.get(`${svc.baseUrl}/api/sales`, { timeout: 5e3 });
